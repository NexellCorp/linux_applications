...
void audio_resample_reinit(ReSampleContext *s, float output_rate, float input_rate);
...
void av_resample_reinit(struct AVResampleContext *c, float out_rate, float in_rate, int filter_size, int phase_shift, int linear, double cutoff);

void av_resample_MakeFilter(struct AVResampleContext *c);
